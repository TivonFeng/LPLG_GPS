///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.10.1.6676/W32 for ARM       23/Apr/2015  14:23:17
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  G:\test\LPLD_OSKinetis_V3_now02\lib\LPLD\HW\HW_PDB.c
//    Command line =  
//        G:\test\LPLD_OSKinetis_V3_now02\lib\LPLD\HW\HW_PDB.c -D LPLD_K60 -lCN
...
//    List file    =  
//        G:\test\LPLD_OSKinetis_V3_now02\project\LPLD_OV7670\iar\FLASH\List\HW_PDB.s
//
///////////////////////////////////////////////////////////////////////////////
...
// G:\test\LPLD_OSKinetis_V3_now02\lib\LPLD\HW\HW_PDB.c
//    1 /**
//    2  * @file HW_PDB.c
...
//  225   PDB0->CH[n].C1 |= cfg;        //根据参数配置BB模式、选择预触发输出、使能预触发
        ...
        MOVS     R7,#+40
        LDR.W    R12,??DataTable5_9  ;; 0x40036010
        MLA      R7,R7,R0,R12
        LDR      R7,[R7, #+0]
        ORRS     R1,R1,R7
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  256   
//  257   if(dacx == DAC0)
        LDR.N    R4,??DataTable5_15  ;; 0x400cc000
        CMP      R0,R4
...
??LPLD_PDB_DacTriggerCfg_0:
        LDR.N    R4,??DataTable5_16  ;; 0x400cd000
        CMP      R0,R4
