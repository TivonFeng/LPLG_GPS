...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  D:\LPLD_OSKinetis_V3www\lib\LPLD\HW\HW_I2C.c
//    Command line =  
//        D:\LPLD_OSKinetis_V3www\lib\LPLD\HW\HW_I2C.c -D LPLD_K60 -lCN
...
//    List file    =  
//        D:\LPLD_OSKinetis_V3www\project\LPLD_OV7670\iar\RAM\List\HW_I2C.s
//
///////////////////////////////////////////////////////////////////////////////
...
// D:\LPLD_OSKinetis_V3www\lib\LPLD\HW\HW_I2C.c
//    1 /*
//    2  * @file HW_I2C.c
...
??LPLD_I2C_Init_6:
        ...
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R0,R9,#0x200
        LDR.N    R1,??DataTable7_10  ;; 0x4004a004
        STR      R0,[R1, #+0]
        B.N      ??LPLD_I2C_Init_7
??LPLD_I2C_Init_11:
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R0,R9,#0x200
        LDR.N    R1,??DataTable7_11  ;; 0x4004a00c
        STR      R0,[R1, #+0]
        B.N      ??LPLD_I2C_Init_7
??LPLD_I2C_Init_2:
...
??LPLD_I2C_Init_14:
        ...
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R0,R9,#0x600
        LDR.N    R1,??DataTable7_15  ;; 0x4004d000
        STR      R0,[R1, #+0]
        B.N      ??LPLD_I2C_Init_7
??LPLD_I2C_Init_15:
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R0,R9,#0x200
        LDR.N    R1,??DataTable7_16  ;; 0x4004b02c
        STR      R0,[R1, #+0]
        B.N      ??LPLD_I2C_Init_7
??LPLD_I2C_Init_12:
        MOVS     R0,#+0
...
`?<Constant "D:\\\\LPLD_OSKinetis_V3w...">`:
        DATA
        DC8 "D:\\LPLD_OSKinetis_V3www\\lib\\LPLD\\HW\\HW_I2C.c"
        DC8 0, 0, 0
