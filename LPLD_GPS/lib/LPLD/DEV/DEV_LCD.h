...
//LCD数据总线基地址
#define LCD_DATA_ADDRESS  (0x60040000)
//LCD复位引脚
#define LCD_SET_RST       PTC12_O=1
#define LCD_CLR_RST       PTC12_O=0
//写寄存器间隔延时
#define LCD_DELAY_TIME    0
/********用户可修改值 结束***********/
#if  ( HORIZONTAL == 1 )
#define  MAX_X  320
#define  MAX_Y  240   
...
//不开窗
void LPLD_LCD_ShowStringno(uint16 , uint16 , uint8 *,uint16  );
